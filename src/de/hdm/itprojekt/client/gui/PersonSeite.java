...
//	private GreetingServiceAsync gwtproxy = GWT.create(GreetingService.class);
//	
//	private FlexTable persontabelle = new FlexTable();
//	
...
//		
//		persontabelle.setWidget(0,1, name);
//		
//		vpanelPerson.add(persontabelle);
//		hpanelPerson.add(bearbeitenbutton);
//		hpanelPerson.add(teambutton);
//		hpanelPerson.add(unternehmenbutton);
//	
...
//		};
//		
//		TextColumn<Person> persontabelleemail = new TextColumn<Person>(){
//
//			@Override
//			public String getValue(Person object) {
//				// TODO Auto-generated method stub
//				return object.getEmailAddresse();
//			}
//			
//		};
//		
...
//		persontabelle.addColumn(persontabelleemail, "E-Mail");
//		
...
//		person1.getId();
//		persontabelle.setRowCount(1);
//		Vector v = new Vector();
//		v.add(person1);
//		persontabelle.setRowData(v);
//		
//		
//
//	}
