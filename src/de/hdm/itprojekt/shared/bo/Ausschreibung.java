...
public class Ausschreibung extends BusinessObject  {
	...
	/**
	 * Beziehung zu Projekt �ber Fremdschl�ssel
	 */
	private int idProjekt;
	
	/**
	 * Beziehung zu Partnerprofil �ber Fremdschl�ssel
	 */
	private int idPartnerprofil;
	
	/**
	 * Beziehung zu Ausschreibendem (Person, Team, Unternehmen) �ber Fremdschl�ssel
	 */
	...
	/**
	 * Auslesen des Fremdschl�ssels idPartnerofil von Partnerprofil
	...
	/**
	 * Auslesen von Fremdschl�ssel idAusschreibender
