...
public interface GreetingService extends RemoteService  {
	...
	// Diese Methode bei jeder Instantiierung verwenden, das heißt diese
	// Methode
	// init()
	...
	public Team anlegenTeam(/* Integer ganz ausgeschrieben?? */int idUnternehmen, int idPartnerprofil, String teamName,
			int mitgliederAnzahl) throws IllegalArgumentException;
