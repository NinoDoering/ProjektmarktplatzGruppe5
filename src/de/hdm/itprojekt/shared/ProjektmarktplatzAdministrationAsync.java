...
public interface ProjektmarktplatzAdministrationAsync <Person, Unternehmen, Team, Projekt, Ausschreibung, 
	...
	//Organisationseinheit org
		...
		void editierenOrganisationseinheit(Organisationseinheit org,  
	...
	//Team t
		void anlegenTeam(Team t, int idTeam, String teamName, int mitgliederAnzahl, 
			AsyncCallback<Team> callback);
		void editierenTem(Team t, String teamName, int mitgliederAnzahl,  
			AsyncCallback<Vector<Team>> callback);
		void loeschenTeam(Team t, int idTeam, 
			AsyncCallback <Void> callback);
					
		void getTeam(Team t, int idTeam, String teamName, int mitgliederAnzahl, 
			AsyncCallback <Vector<Team>> callback);
		
	//Unternehmen u
		void anlegenUnternehmen(Unternehmen u, int idUnternehmen, String firmenName,  
			AsyncCallback<Unternehmen> callback);
		void editierenUnternehmen(Unternehmen u, String firmenName,  
			AsyncCallback<Vector<Unternehmen>> callback);
		void loeschenUnternehmen(Unternehmen u, int idUnternehmen, String firmenName,  
			AsyncCallback <Void> callback);
	...
	//Getter-By-All Option
		void getBewertungById(int idBewertung, Bewertung bg,
				AsyncCallback <Vector<Bewertung>> callback);
		void getBewertungByBewerbungId(Bewertung bg, int idBewertung, Bewerbung b, int idBewerbung,
				AsyncCallback <Vector<Bewertung>> callback);
		void getAlleAusschreibung(Ausschreibung a, int idAusschreibung,
				AsyncCallback <Vector<Ausschreibung>> callback);
		...
		void getBeteiligungByidOrganisationseinheit(Beteiligung beteiligung, int idBeteiligung, int idOrgansisationseinheit,
				AsyncCallback <Vector<Beteiligung>> callback);
		void getAllByidBewerbungen(Bewerbung b, int idBewerbung,
				AsyncCallback <Vector<Bewerbung>> callback);
}
