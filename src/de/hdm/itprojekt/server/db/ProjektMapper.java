...
public class ProjektMapper {
	...
	public Vector <Projekt> findAll() {
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("SELECT id, bezeichnung, beschreibung, startDatum, endDatum, projektleiter " 
	...
	try {
		...
		+ "startDatum=\"" + p.getStartDatum() + "\"," + "endDatum=\"" + p.getEndDatum() + "\"," + "projektleiter=\"" + p.getProjektleiter()+ "\" "
		+ "WHERE id" + p.getId()); 
